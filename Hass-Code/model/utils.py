...
def initialize_tree(input_ids, model, past_key_values, logits_processor, return_logprobs=False):
    ...
    if return_logprobs:
        draft_tokens, retrieve_indices, tree_mask, tree_position_ids, draft_logprobs = model.ea_layer.topK_genrate(
            hidden_states, input_ids, model.base_model.lm_head, logits_processor, return_logprobs=True
        )
        return draft_tokens, retrieve_indices, tree_mask, tree_position_ids, orig, hidden_states, token, draft_logprobs
    else:
