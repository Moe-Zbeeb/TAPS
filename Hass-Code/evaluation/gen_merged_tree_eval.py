"""Evaluate merged-tree dual-head HASS and record τ.
...
def get_model_answers(
    ...
    for _ in range(3):
        ...
        for j in range(len(question["turns"])):
            ...
            output_ids, new_token, idx, _, _ = model.merged_eagenerate(
    ...
    for question in tqdm(questions):
        ...
        for i in range(num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                output_ids, new_token, idx, accept_length_list, _ = model.merged_eagenerate(
                    torch.as_tensor(input_ids).cuda(),
                    temperature=temperature,
                    log=True,
                    is_llama3=True,
...
if __name__ == "__main__":
    ...
    answer_file = args.answer_file or (
        f"results/merged/{args.bench_name}_{args.model_id}.jsonl"
    )
