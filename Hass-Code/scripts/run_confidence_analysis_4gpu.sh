...
EA_PATHS=(
  "checkpoints/MathInstruct_20epochs"
  "checkpoints/ShareGPT_20epochs"
  "checkpoints/Sharegpt-Mathinstruct-20epochs"
  "checkpoints/Averaged-Checkpoint"
)
...
for i in 0 1 2 3; do
  ...
  CUDA_VISIBLE_DEVICES="${gpu}" \
    python -m evaluation.gen_confidence_analysis \
